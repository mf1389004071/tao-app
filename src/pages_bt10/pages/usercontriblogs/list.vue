...
function handleShow(id) {
  tab.navigateTo("/pages_bt10/pages/usercontriblogs/show?id=" + id)
}
/** 查看详情按钮操作 */
function handleEdit(id) {
  tab.navigateTo("/pages_bt10/pages/usercontriblogs/edit?id=" + id)
}
function handleAdd(id) {
  tab.navigateTo("/pages_bt10/pages/usercontriblogs/edit")
}
