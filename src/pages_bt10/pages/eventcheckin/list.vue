...
function handleShow(id) {
  tab.navigateTo("/pages_bt10/pages/eventcheckin/show?id=" + id)
}
/** 查看详情按钮操作 */
function handleEdit(id) {
  tab.navigateTo("/pages_bt10/pages/eventcheckin/edit?id=" + id)
}
function handleAdd(id) {
  tab.navigateTo("/pages_bt10/pages/eventcheckin/edit")
}
