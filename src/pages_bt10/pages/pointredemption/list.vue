  ...
  <view>
    <uni-table border stripe type="selection" emptyText="暂无更多数据" :loading="loading">
      <uni-tr>
        ...
        <uni-th>消耗积分</uni-th>
        <uni-th>状态：待发放/已核销/已取消/已过期</uni-th>
        <uni-th>兑换码</uni-th>
...
function handleShow(id) {
  tab.navigateTo("/pages_bt10/pages/pointredemption/show?id=" + id)
}
/** 查看详情按钮操作 */
function handleEdit(id) {
  tab.navigateTo("/pages_bt10/pages/pointredemption/edit?id=" + id)
}
function handleAdd(id) {
  tab.navigateTo("/pages_bt10/pages/pointredemption/edit")
}
