...
function handleShow(identityCode) {
  tab.navigateTo("/pages_bt10/pages/identities/show?identityCode=" + identityCode)
}
/** 查看详情按钮操作 */
function handleEdit(identityCode) {
  tab.navigateTo("/pages_bt10/pages/identities/edit?identityCode=" + identityCode)
}
function handleAdd(identityCode) {
  tab.navigateTo("/pages_bt10/pages/identities/edit")
}
