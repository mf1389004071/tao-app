...
function handleShow(userId) {
  tab.navigateTo("/pages_bt10/pages/userprofiles/show?userId=" + userId)
}
/** 查看详情按钮操作 */
function handleEdit(userId) {
  tab.navigateTo("/pages_bt10/pages/userprofiles/edit?userId=" + userId)
}
function handleAdd(userId) {
  tab.navigateTo("/pages_bt10/pages/userprofiles/edit")
}
