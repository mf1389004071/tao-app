...
function handleShow(id) {
  tab.navigateTo("/pages/bt10/pointchangelogs/show?id=" + id)
}
/** 查看详情按钮操作 */
function handleEdit(id) {
  tab.navigateTo("/pages/bt10/pointchangelogs/edit?id=" + id)
}
function handleAdd(id) {
  tab.navigateTo("/pages/bt10/pointchangelogs/edit")
}
