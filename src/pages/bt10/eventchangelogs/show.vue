<template>
  <view>
    <uni-card :is-shadow="false" is-full>
      ...
      <uni-section title="备注" :sub-title="eventchangelogs.remark" type="line"></uni-section>
      <uni-section title="状态" :sub-title="eventchangelogs.status" type="line"></uni-section>
    </uni-card>
  </view>
</template>
